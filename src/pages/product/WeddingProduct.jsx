  ...
  const LoadingSkeleton = () => (
    <div className="space-y-8">
      {[1, 2, 3].map((item) => (
        <div
          key={item}
          className="relative flex w-full max-w-[90rem] mx-auto h-[300px] md:h-[350px] rounded-3xl bg-gray-700 animate-pulse"
        />
      ))}
    </div>
  );
    ...
    <section className="bg-[#120d0d] relative overflow-hidden py-5 px-6">
      <div className="container mx-auto max-w-[90rem]">
        ...
        {isLoading ? (
          ...
          <div className="text-white text-center mt-16">No Product Available</div>
        ) : (
            ...
            {products.map((product, index) => (
              ...
              >
                <img
                  ...
                  className="w-full h-[260px] md:h-[320px] lg:h-[380px] object-cover transition-transform duration-700 hover:scale-110"
                />
              </motion.div>
            ))}
          </div>
