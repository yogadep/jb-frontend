    ...
    return (
        <section className="bg-[#120d0d] relative overflow-hidden py-5 px-6">
            <div className="container mx-auto max-w-[90rem]">
                ...
                >
                    <h2 className="text-4xl font-bold text-white">Maternity Photography</h2>
                </motion.div>
                            ...
                            >
                                ...
                                >
                                    <div className="rounded-[2rem] overflow-hidden">
                                        <img
                                            ...
                                            alt={product?.name || 'Maternity Photography'}
                                            onError={(e) => {
                                ...
                                >
                                    {/* <h3 className="text-3xl font-bold text-white sm:mb-0">
                                        {product.name || 'Maternity Collection'}
                                    </h3>
...
export default MaternityProduct;